...
If user chose "No images" in Phase 1, skip this entirely.
...
```
presentations/[name]-slides.html    # Self-contained, all CSS/JS inline
presentations/[name]-assets/        # Images only, if any
```
