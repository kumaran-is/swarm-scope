...
- **Backend (Node.js)**: Node.js 24.14.x, NestJS 11.17.x (Fastify adapter), Prisma ORM, TypeScript 5.9.x — npm, Cloud Run
...
- **Frontend**: Angular 21.x (TypeScript 5.9.x, RxJS, SCSS) — npm build, Firebase Hosting
