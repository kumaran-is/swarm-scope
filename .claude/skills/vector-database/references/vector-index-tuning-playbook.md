...
Reference file for the `vector-database` skill. Covers quantization strategies, HNSW benchmarking,
memory estimation, and Qdrant configuration — content not covered in `pgvector-migration-template.md`.
...
## Template 1: HNSW Parameter Benchmarking
...
- Start with defaults — tune only when evidence demands it
- Use quantization — significant memory savings with INT8 (4x) or PQ (16x+)
- Consider tiered storage — hot/cold data separation

### Don't
- Don't over-optimize early — profile first
- Don't ignore build time — index updates have cost
- Don't forget reindexing — plan for maintenance windows
